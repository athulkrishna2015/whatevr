        ...
        {"text-with-reply",
         withProps(baseProps(),
                   {{QStringLiteral("messageId"), QStringLiteral("m4")},
                    ...
                    {QStringLiteral("replyToText"), shortBody}}), 95},
        {"text-with-sender-header",
         withProps(baseProps(),
                   {{QStringLiteral("messageId"), QStringLiteral("m5")},
                    ...
                    {QStringLiteral("showSenderGutter"), true}}), 95},
        {"image",
         withProps(baseProps(),
        ...
        {"video",
         withProps(baseProps(),
                   {{QStringLiteral("messageId"), QStringLiteral("m6-video")},
                    ...
                    {QStringLiteral("mediaDurationSecs"), 12}}), 136},
        {"sticker",
         withProps(baseProps(),
