        ...
        {"text-with-reply",
         withProps(baseProps(),
                   {{QStringLiteral("messageId"), QStringLiteral("m4")},
                    ...
                    {QStringLiteral("replyToText"), shortBody}}), 97},
        {"text-with-sender-header",
         withProps(baseProps(),
                   {{QStringLiteral("messageId"), QStringLiteral("m5")},
                    ...
                    {QStringLiteral("showSenderGutter"), true}}), 97},
        {"image",
         withProps(baseProps(),
        ...
        {"video",
         withProps(baseProps(),
                   {{QStringLiteral("messageId"), QStringLiteral("m6-video")},
                    ...
                    {QStringLiteral("mediaDurationSecs"), 12}}), 138},
        {"sticker",
         withProps(baseProps(),
        ...
        {"voice",
         withProps(baseProps(),
                   {{QStringLiteral("messageId"), QStringLiteral("m8")},
                    ...
                    {QStringLiteral("mediaDurationSecs"), 6}}), 141},
        {"video-note",
         withProps(baseProps(),
