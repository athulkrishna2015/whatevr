...
QtObject {
    ...
    readonly property var searchIndex: [
        ...
        { moduleId: "chats", category: Whatevr.I18n.i18nc("@title settings category", "Chats"),
          rowId: "chats.snapToBottomOnSend", label: Whatevr.I18n.i18nc("@label", "Jump to the newest message when sending"),
          description: Whatevr.I18n.i18nc("@info", "Scroll the conversation down to your message even if you were reading further up."),
          keywords: ["scroll", "jump", "bottom", "snap", "send", "newest", "follow"] },
        { moduleId: "chats", category: Whatevr.I18n.i18nc("@title settings category", "Chats"),
        ...
        { moduleId: "advanced", category: Whatevr.I18n.i18nc("@title settings category", "Advanced"),
          rowId: "advanced.gifPlayerLimit", label: Whatevr.I18n.i18nc("@label", "GIFs playing at once"),
          description: "",
          keywords: ["gif", "animated", "inline", "limit", "decoder", "performance", "memory", "pool"] },
        { moduleId: "advanced", category: Whatevr.I18n.i18nc("@title settings category", "Advanced"),
