...
type rawMessageBuilder func(client *whatsmeow.Client, params json.RawMessage) (*waE2E.Message, error)
...
func (c *Client) SendRawMessage(ctx context.Context, req RawSendRequest) (string, error) {
	...
	message, err := build(client, req.Params)
	if err != nil {
...
func buildRawText(client *whatsmeow.Client, params json.RawMessage) (*waE2E.Message, error) {
	var p struct {
...
func buildRawLocation(client *whatsmeow.Client, params json.RawMessage) (*waE2E.Message, error) {
...
func buildRawLiveLocation(client *whatsmeow.Client, params json.RawMessage) (*waE2E.Message, error) {
	message, err := buildRawLocation(client, params)
	if err != nil {
		return nil, err
	}
	live := true
...
// for.
func buildRawLiveLocationUpdate(client *whatsmeow.Client, params json.RawMessage) (*waE2E.Message, error) {
	var p rawLocationParams
	if err := decodeRawParams(params, &p); err != nil {
		return nil, err
	}
...
func buildRawContact(client *whatsmeow.Client, params json.RawMessage) (*waE2E.Message, error) {
...
func buildRawContacts(client *whatsmeow.Client, params json.RawMessage) (*waE2E.Message, error) {
	var p rawContactParams
	if err := decodeRawParams(params, &p); err != nil {
		return nil, err
	}
...
func buildRawPoll(client *whatsmeow.Client, params json.RawMessage) (*waE2E.Message, error) {
	var p struct {
